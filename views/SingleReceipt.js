  ...
  const arrangeReceipt = () => {
    ...
    if (
      ...
      let organizedObj = receipt.items?.reduce((reducedReceipt, item) => {
        let fullName = item.itemizedTransactions[0]?.debtor
      ...
      for (let fullName in organizedObj) {
        if (fullName === 'Unassigned Items')
          returnArray.unshift({items: organizedObj[fullName], fullName})
        else returnArray.push({items: organizedObj[fullName], fullName})
      }
  ...
  return (
    <View style={{height: '100%'}}>
      ...
      <ScrollView style={{flex: 1}}>
        {arrangedReceipt && arrangedReceipt.length ? (
            ...
            return (
              ...
              >
                <View style={{flexDirection: 'column'}}>
                  ...
                  >
                    <Text style={[singleReceiptStyles.cochin, {fontSize: 17}]}>
          ...
          <Text>There are no items in this receipt</Text>
        )}
      </ScrollView>
    </View>
  )
